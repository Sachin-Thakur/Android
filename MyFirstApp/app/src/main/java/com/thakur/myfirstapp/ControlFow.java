...
public class ControlFow {
    ...
    public void start(){
        ...
        char[] sentenceToTest = toCharacterArray("The quick fox over wn dog");
        ...
        // Find out if the 'sentenceToTest' is a pangram.
    ...
    /*
    char[] alphabet ={'a','b','','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};
     ...
     public void start() {
         ...
         char[] sentenceToTest = toCharacterArray("The Quick red fox jumps over the lazy bwon dog ");
         char[] missingLetters = new char[26];
